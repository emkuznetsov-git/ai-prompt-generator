...
const LEXICONS_DATA = {
    ...
    subject: {
    items: [
        // Locked physical archetypes (hair color anchored)
        { id: "blonde_bombshell", label: "Blonde bombshell (locked)", text_en: "platinum blonde hair, long glamorous waves, slim hourglass silhouette, confident direct gaze", tags: ["hair_blonde", "hair_long", "body_slim", "gaze_confident"], weight: 1.0 },
        { id: "blonde_playmate_hot", label: "Blonde playmate (hot, locked)", text_en: "platinum blonde hair, long soft waves, slim hourglass silhouette, playful seductive smile, bedroom eyes", tags: ["hair_blonde", "hair_long", "body_slim", "gaze_teasing", "hot", "sexy"], weight: 0.85 },
        { id: "blonde_ice_queen", label: "Blonde ice queen (locked)", text_en: "platinum blonde hair, sleek straight hair, slim tall silhouette, cold confident gaze", tags: ["hair_blonde", "hair_straight", "body_slim", "gaze_intense", "sexy"], weight: 0.65 },

        { id: "brunette_femme_fatale", label: "Brunette femme fatale (locked)", text_en: "deep brunette hair, long glossy waves, slim athletic silhouette, intense controlled gaze", tags: ["hair_brunette", "hair_long", "body_slim", "gaze_intense"], weight: 1.0 },
        { id: "brunette_midnight_siren", label: "Brunette midnight siren (hot, locked)", text_en: "deep brunette hair, long glossy waves, slim athletic silhouette, sultry direct gaze, subtle smirk", tags: ["hair_brunette", "hair_long", "body_slim", "gaze_intense", "hot", "sexy"], weight: 0.9 },
        { id: "brunette_slicked_power", label: "Brunette slicked power (hot, locked)", text_en: "deep brunette hair, slicked-back wet-look hair, slim athletic silhouette, dominant runway gaze", tags: ["hair_brunette", "hair_slickback", "body_slim", "gaze_confident", "hot", "sexy", "edgy"], weight: 0.6 },

        { id: "dirty_blonde_sleek", label: "Dirty blonde sleek (locked)", text_en: "dirty blonde hair, sleek straight hair, slim silhouette, teasing gaze", tags: ["hair_dirty_blonde", "hair_straight", "body_slim", "gaze_teasing"], weight: 0.75 },
        { id: "dirty_blonde_girl_next_door_hot", label: "Dirty blonde tease (hot, locked)", text_en: "dirty blonde hair, soft blowout waves, slim silhouette, teasing smile, flirty gaze", tags: ["hair_dirty_blonde", "hair_blowout", "body_slim", "gaze_teasing", "hot", "sexy"], weight: 0.55 },

        { id: "redhead_sophisticated", label: "Redhead sophisticated (locked)", text_en: "rich auburn red hair, long soft waves, slim silhouette, elegant confident gaze", tags: ["hair_red", "hair_long", "body_slim", "gaze_elegant"], weight: 0.7 },
        { id: "redhead_pinup_tease", label: "Redhead pin-up tease (sexy, locked)", text_en: "rich auburn red hair, vintage-inspired soft waves, slim silhouette, playful teasing gaze", tags: ["hair_red", "hair_long", "body_slim", "gaze_playful", "sexy", "vintage"], weight: 0.45 }
    ]
},

      beauty: {
    items: [
        // Base glamour (safe defaults)
        ...
        { id: "soft_blowout_playful", label: "Soft blowout + playful", text_en: "soft blowout waves, playful teasing smile, soft smoky eyes, glossy lips, natural skin texture", tags: ["hair_blowout", "mood_playful", "makeup_soft_smoky", "finish_glossy"], weight: 0.95 },
        { id: "sleek_straight_winged", label: "Sleek straight + winged", text_en: "sleek glossy straight hair, winged eyeliner, glossy lips, clean editorial finish", tags: ["hair_sleek", "hair_straight", "makeup_winged", "finish_clean"], weight: 0.95 },
        { id: "ponytail_smoky", label: "Ponytail + smoky", text_en: "sleek ponytail, smoky eyes, glossy lips, confident teasing expression, natural skin texture", tags: ["hair_ponytail", "makeup_smoky", "mood_teasing", "finish_glossy"], weight: 0.9 },
        { id: "soft_waves_glowing", label: "Soft waves + glowing", text_en: "soft waves, glowing skin, glossy lips, natural texture, premium editorial finish", tags: ["hair_waves", "finish_glow", "finish_premium"], weight: 0.9 },

        // Hotter / night-glam (B2–B3 friendly)
        { id: "night_glam_deep_smoky", label: "Night glam + deep smoky (hot)", text_en: "night-glam deep smoky eyes, high-glam contour, glossy lips, subtle body highlight, premium editorial finish", tags: ["night_glam", "makeup_smoky", "contour", "hot", "sexy"], weight: 0.85 },
        { id: "cat_eye_red_lip", label: "Cat-eye + red lips (hot)", text_en: "sharp cat-eye eyeliner, bold red lipstick, sculpted cheekbones, clean luminous skin, classic bombshell glam", tags: ["makeup_winged", "red_lip", "classic_hot", "hot", "sexy"], weight: 0.7 },
        { id: "glitter_lids_gloss", label: "Glitter lids + gloss (hot)", text_en: "subtle glitter eyelids, smoky liner, glossy lips, luminous skin, night-out glamour", tags: ["night_glam", "glitter", "finish_glossy", "hot", "sexy"], weight: 0.65 },
        { id: "metallic_smoky_highlight", label: "Metallic smoky + highlight", text_en: "metallic smoky eyes, wet highlighter on cheekbones, glossy lips, crisp editorial finish", tags: ["makeup_smoky", "metallic", "finish_glow", "night_glam"], weight: 0.55 },
        { id: "bronzed_sunkissed_glow", label: "Bronzed sunkissed glow", text_en: "bronzed sun-kissed glow, soft defined eyes, glossy lips, warm skin radiance, premium finish", tags: ["bronzed", "finish_glow", "warm"], weight: 0.55 },

        // Hair looks that add attitude (still hair-color neutral)
        { id: "wet_look_slickback_hot", label: "Wet-look slickback (edgy hot)", text_en: "slicked-back wet-look hair, sharp liner, glossy lips, high-fashion attitude, premium editorial finish", tags: ["hair_slickback", "wet_look", "edgy", "hot", "sexy"], weight: 0.5 },
        { id: "high_ponytail_cat_eye", label: "High ponytail + cat-eye", text_en: "high sleek ponytail, sharp cat-eye eyeliner, glossy lips, confident night-glam vibe", tags: ["hair_ponytail", "makeup_winged", "night_glam", "hot"], weight: 0.5 },
        { id: "messy_bedhair_smoky", label: "Messy bed-hair + smoky (hot)", text_en: "messy bed-hair waves, smoky eyes, glossy lips, teasing expression, realistic skin texture", tags: ["hair_waves", "makeup_smoky", "mood_teasing", "hot", "sexy"], weight: 0.55 },
        { id: "vintage_pinup_redlip", label: "Vintage pin-up + red lips", text_en: "vintage-inspired waves, classic liner, red lipstick, playful pin-up glamour, premium finish", tags: ["vintage", "red_lip", "makeup_winged", "classic_hot", "sexy"], weight: 0.35 }
    ]
},
    ...
    items: [
        ...
        { id: "black_lace_corset", label: "Black lace corset set", text_en: "black lace corset lingerie with satin trim, structured boning, high-waist briefs, sheer lace-top stockings", tags: ["color_black", "lace", "corset", "stockings", "sexy", "classic"], weight: 0.75 },
        { id: "black_lace_bustier", label: "Black lace bustier set", text_en: "black lace bustier set with clean structure, high-waist briefs, subtle fine fishnet stockings (tasteful)", tags: ["color_black", "lace", "bustier", "fishnet", "sexy", "classic"], weight: 0.7 },
        { id: "deep_red_satin", label: "Deep red satin set", text_en: "deep red satin lingerie set with subtle black lace trim, sheer black stockings", tags: ["color_red", "satin", "stockings", "sexy"], weight: 0.6 },
        { id: "ivory_satin_balconette", label: "Ivory satin balconette set", text_en: "ivory satin balconette set with lace trim, sheer beige lace-top stockings", tags: ["color_ivory", "satin", "balconette", "stockings", "classic"], weight: 0.55 },
        { id: "ivory_lace_bodysuit", label: "Ivory lace bodysuit", text_en: "ivory lace bodysuit lingerie with satin panel details, sheer beige stockings", tags: ["color_ivory", "lace", "bodysuit", "stockings", "classic"], weight: 0.5 },

        // High-impact sexy (ad-safe, non-explicit) — push for B2/B3
        { id: "black_strappy_garter_set", label: "Black strappy set + garters (hot)", text_en: "black strappy lingerie set with garter belt and gold hardware, high-leg briefs, sheer black stockings (lace-top)", tags: ["color_black", "strappy", "garter", "hardware_gold", "stockings", "hot", "sexy"], weight: 1.0 },
        { id: "black_cage_bra_garter", label: "Black cage bra + garter (hot)", text_en: "black cage-bra lingerie set with tasteful strap geometry and gold rings, high-leg thong briefs, garter belt, sheer black stockings", tags: ["color_black", "cage", "strappy", "garter", "thong", "hardware_gold", "hot", "sexy", "statement"], weight: 0.9 },
        { id: "black_harness_inspired_set", label: "Harness-inspired lingerie (hot)", text_en: "black harness-inspired lingerie set (fashion body-harness inspired), clean straps with minimal hardware, high-leg briefs, sheer black stockings", tags: ["color_black", "harness", "strappy", "bold", "hot", "sexy"], weight: 0.8 },
        { id: "black_satin_triangle_thong_set", label: "Satin triangle + thong (hot)", text_en: "black satin triangle bra with lined cups, matching high-leg thong briefs, sheer black stockings, minimal gold jewelry accents", tags: ["color_black", "satin", "thong", "minimal", "hot", "sexy"], weight: 0.75 },
        { id: "sheer_mesh_plunge_bodysuit", label: "Sheer mesh plunge bodysuit (hot)", text_en: "sheer black mesh plunge bodysuit with strategically placed opaque panels, clean seams, high-leg cut, sheer black stockings", tags: ["color_black", "mesh", "bodysuit", "sheer", "hot", "sexy"], weight: 0.85 },
        { id: "black_cutout_bodysuit", label: "Cutout bodysuit (hot)", text_en: "black cutout bodysuit lingerie with tasteful geometric cutouts and opaque panels, sheer black stockings, minimal body chain jewelry", tags: ["color_black", "cutout", "bodysuit", "hot", "sexy", "statement"], weight: 0.75 },
        { id: "black_teddy_open_back", label: "Open-back teddy (hot)", text_en: "black lace teddy with satin accents, open-back design (tasteful), high-leg cut, sheer black stockings", tags: ["color_black", "teddy", "lace", "open-back", "hot", "sexy"], weight: 0.7 },
        { id: "rhinestone_crystal_strap_set", label: "Crystal strap set (statement)", text_en: "black lingerie set with crystal strap details and clean lines, high-leg briefs, sheer black stockings", tags: ["color_black", "crystal", "statement", "strappy", "hot", "sexy"], weight: 0.7 },
        { id: "latex_look_strappy_set", label: "Latex-look strappy set (edgy hot)", text_en: "black latex-look strappy lingerie set with controlled glossy highlights and minimal hardware, sheer black stockings", tags: ["color_black", "latex-look", "edgy", "strappy", "hot", "sexy"], weight: 0.65 },
        { id: "latex_look_bodysuit_clean", label: "Latex-look bodysuit (editorial hot)", text_en: "black latex-look bodysuit with clean seams and controlled glossy highlights, high-leg cut, sheer black stockings", tags: ["color_black", "latex-look", "bodysuit", "edgy", "hot", "sexy"], weight: 0.55 },
        { id: "deep_red_strappy_set", label: "Deep red strappy set (hot)", text_en: "deep red strappy lingerie set with gold hardware, high-leg briefs, sheer black stockings", tags: ["color_red", "strappy", "hardware_gold", "hot", "sexy"], weight: 0.6 },
        { id: "hot_pink_strappy_set", label: "Hot pink strappy set (statement)", text_en: "hot pink satin strappy lingerie set with clean lines, high-leg briefs, sheer black stockings for contrast", tags: ["color_pink", "satin", "strappy", "statement", "hot", "sexy"], weight: 0.35 },
        { id: "white_lace_sheer_set", label: "White lace sheer set (contrast sexy)", text_en: "white lace lingerie set with lined cups (no explicit), high-leg briefs, sheer beige stockings, clean bridal-glam contrast", tags: ["color_white", "lace", "sheer", "sexy", "statement"], weight: 0.35 },
        { id: "animal_print_mesh_set", label: "Animal print mesh set (bold)", text_en: "animal-print mesh lingerie set with opaque panels and clean seams, high-leg briefs, sheer black stockings", tags: ["print", "mesh", "bold", "hot", "sexy"], weight: 0.25 }
    ]
},

      shoes: {
    items: [
        // Pumps / heels (high readability)
        { id: "black_patent_pumps", label: "Black patent pumps", text_en: "black patent pointed-toe pumps with a slim stiletto heel", tags: ["pumps", "patent", "color_black", "stiletto", "sexy"], weight: 0.8, constraints: { requires: ["include floor"] } },
        { id: "black_platform_pumps", label: "Black platform pumps (hot)", text_en: "black platform pumps with an ultra-high slim stiletto heel", tags: ["pumps", "platform", "color_black", "hot", "sexy", "statement", "stiletto"], weight: 0.9, constraints: { requires: ["include floor"] } },
        { id: "black_ankle_cuff_stilettos", label: "Black ankle-cuff stilettos (hot)", text_en: "black patent ankle-cuff stilettos with a pointed toe and slim high heel", tags: ["stilettos", "ankle-cuff", "patent", "color_black", "hot", "sexy", "stiletto"], weight: 0.85, constraints: { requires: ["include floor"] } },
        { id: "black_crystal_ankle_strap_pumps", label: "Crystal ankle-strap pumps (statement)", text_en: "black pointed-toe pumps with a crystal ankle strap and slim stiletto heel", tags: ["pumps", "color_black", "crystal", "statement", "hot", "sexy", "stiletto"], weight: 0.55, constraints: { requires: ["include floor"] } },
        { id: "beige_patent_stilettos", label: "Beige patent stilettos", text_en: "beige patent stilettos with a slim high heel", tags: ["stilettos", "patent", "color_beige", "sexy", "stiletto"], weight: 0.45, constraints: { requires: ["include floor"] } },
        { id: "red_patent_stilettos", label: "Red patent stilettos (hot)", text_en: "deep red patent stilettos with pointed toe and high slim heel", tags: ["stilettos", "patent", "color_red", "hot", "sexy", "stiletto"], weight: 0.5, constraints: { requires: ["include floor"] } },
        { id: "metallic_silver_pumps", label: "Metallic silver pumps", text_en: "metallic silver pointed-toe pumps with a slim stiletto heel", tags: ["pumps", "metallic", "statement", "sexy", "stiletto"], weight: 0.25, constraints: { requires: ["include floor"] } },

        // Strappy sandals (ultra sexy silhouettes)
        { id: "black_laceup_stiletto_sandals", label: "Black lace-up stiletto sandals (hot)", text_en: "black lace-up stiletto sandals wrapping the ankles, ultra-thin straps, high slim heel", tags: ["sandals", "lace-up", "strappy", "color_black", "hot", "sexy", "stiletto"], weight: 0.8, constraints: { requires: ["include floor"] } },
        { id: "black_barely_there_sandals", label: "Barely-there strap sandals (hot)", text_en: "black barely-there strap sandals with thin toe strap and ankle strap, ultra-high slim stiletto heel", tags: ["sandals", "strappy", "color_black", "hot", "sexy", "stiletto"], weight: 0.65, constraints: { requires: ["include floor"] } },

        // Boots (signature lingerie campaign look)
        { id: "knee_high_suede_boots", label: "Knee-high suede boots", text_en: "knee-high black suede boots with a slim stiletto heel", tags: ["boots", "suede", "knee-high", "color_black", "sexy", "stiletto"], weight: 0.6, constraints: { requires: ["include floor"] } },
        { id: "knee_high_leather_boots", label: "Knee-high leather boots", text_en: "knee-high black leather boots with a slim stiletto heel", tags: ["boots", "leather", "knee-high", "color_black", "sexy", "stiletto"], weight: 0.45, constraints: { requires: ["include floor"] } },
        { id: "thigh_high_patent_boots", label: "Thigh-high patent boots (hot)", text_en: "over-the-knee black patent thigh-high boots with a slim stiletto heel", tags: ["boots", "patent", "thigh-high", "hot", "sexy", "statement", "stiletto"], weight: 0.85, constraints: { requires: ["include floor"] } },
        { id: "thigh_high_suede_boots", label: "Thigh-high suede boots (hot)", text_en: "over-the-knee black suede thigh-high boots with a slim stiletto heel", tags: ["boots", "suede", "thigh-high", "hot", "sexy", "stiletto"], weight: 0.65, constraints: { requires: ["include floor"] } },
        { id: "thigh_high_patent_laceup_boots", label: "Thigh-high lace-up patent boots (statement)", text_en: "over-the-knee black patent thigh-high boots with lace-up back detail and slim stiletto heel", tags: ["boots", "patent", "thigh-high", "lace-up", "hot", "sexy", "statement", "stiletto"], weight: 0.75, constraints: { requires: ["include floor"] } },
        { id: "ankle_boots_stiletto", label: "Ankle boots stiletto", text_en: "black leather ankle boots with pointed toe and slim stiletto heel", tags: ["boots", "ankle", "leather", "color_black", "sexy", "stiletto"], weight: 0.3, constraints: { requires: ["include floor"] } },

        // Editorial extras
        { id: "clear_heel_mules", label: "Clear-heel mules (editorial)", text_en: "minimal black mules with a clear sculptural heel, high-fashion editorial look", tags: ["mules", "statement", "modern", "sexy"], weight: 0.2, constraints: { requires: ["include floor"] } }
    ]
},
...
randomSelectModule(module, context) {
    ...
    const resolved = (typeof context === 'object' && context) ? (context.resolved || {}) : {};
    ...
    const boldLevel = (typeof boldness === 'string' && /^B\d$/.test(boldness))
        ...
        : (typeof boldness === 'number' ? boldness : 1);

    // Subject tags (for compatibility weighting)
    let subjectTags = [];
    if (resolved && resolved.subject) {
        const subjectItem = this.getModuleItem('subject', resolved.subject);
        subjectTags = (subjectItem && subjectItem.tags) ? subjectItem.tags : [];
    }
    ...
    const weightedCandidates = candidates.map(item => {
        ...
        // SUBJECT: prefer sexier archetypes when B2/B3
        if (module === 'subject') {
            const isHotSubject = tags.includes('hot') || tags.includes('sexy') || tags.includes('edgy');
            const isElegant = tags.includes('gaze_elegant') || tags.includes('vintage');

            if (boldLevel >= 2) {
                if (isHotSubject) w *= 1.35;
                if (isElegant) w *= 0.9;
            } else if (boldLevel === 0) {
                if (isElegant) w *= 1.15;
                if (isHotSubject) w *= 0.85;
            } else {
                if (isHotSubject) w *= 1.1;
            }
        }

        // BEAUTY: compatibility with subject hair style + hotter makeup on B2/B3
        if (module === 'beauty') {
            const isHotBeauty = tags.includes('hot') || tags.includes('sexy') || tags.includes('night_glam') ||
                tags.includes('glitter') || tags.includes('red_lip') || tags.includes('wet_look') || tags.includes('makeup_smoky');

            // Hair compatibility (soft)
            const subjLong = subjectTags.includes('hair_long');
            const subjStraight = subjectTags.includes('hair_straight');
            const subjSlick = subjectTags.includes('hair_slickback');
            const subjBlowout = subjectTags.includes('hair_blowout');

            const bWaves = tags.includes('hair_waves');
            const bBlowout = tags.includes('hair_blowout');
            const bStraight = tags.includes('hair_straight') || tags.includes('hair_sleek');
            const bPony = tags.includes('hair_ponytail');
            const bSlick = tags.includes('hair_slickback');

            if (subjSlick) {
                if (bSlick) w *= 1.35;
                else w *= 0.9;
            } else if (subjStraight) {
                if (bStraight || bPony) w *= 1.2;
                if (bWaves || bBlowout) w *= 0.9;
            } else if (subjBlowout) {
                if (bBlowout || bWaves) w *= 1.2;
            } else if (subjLong) {
                if (bWaves || bBlowout) w *= 1.15;
                if (bSlick) w *= 0.75;
            }

            // Boldness weighting
            if (boldLevel >= 2) {
                if (isHotBeauty) w *= 1.55;
                if (tags.includes('glitter') || tags.includes('red_lip')) w *= 1.15;
            } else if (boldLevel === 0) {
                if (isHotBeauty) w *= 0.8;
                if (tags.includes('finish_clean')) w *= 1.1;
            } else {
                if (isHotBeauty) w *= 1.15;
            }
        }

        // WARDROBE/SHOES: push "hot" items harder on B2/B3
        if (module === 'wardrobe' || module === 'shoes') {
            const hotSignals = [
                'hot','sexy','bold','strappy','garter','latex-look','thigh-high','platform','stiletto',
                'thong','cutout','cage','harness','mesh','crystal','open-back','statement','patent'
            ];
            const isHot = hotSignals.some(t => tags.includes(t));
            const isClassic = tags.includes('classic');

            if (boldLevel >= 2) {
                if (isHot) w *= 2.2;
                if (tags.includes('statement')) w *= 1.4;
                if (isClassic) w *= 0.7;
            } else if (boldLevel === 0) {
                if (isClassic) w *= 1.7;
                if (isHot) w *= 0.7;
        ...
        // SCENE: on B2/B3 lean into night/backstage/hotel/noir
        if (module === 'scene') {
            const isNightSexy = tags.includes('time_night') || tags.includes('set_backstage') || tags.includes('set_hotel') ||
                tags.includes('mood_noir') || tags.includes('neon') || tags.includes('cinematic');
            if (boldLevel >= 2 && isNightSexy) w *= 1.25;
        }
