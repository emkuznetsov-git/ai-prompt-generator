...
const LEXICONS_DATA = {
    ...
    subject: {
        items: [
          // --- Improved existing (more differentiated) ---
          {
            id: "blonde_bombshell",
            label: "Blonde bombshell",
            text_en: "classic glamour bombshell energy, playful confidence, radiant smile, direct camera gaze",
            tags: ["blonde", "bombshell", "classic-glam", "playful"],
            weight: 1.0
          },
          {
            id: "brunette_femme_fatale",
            label: "Brunette femme fatale",
            text_en: "brunette femme fatale energy, intense controlled gaze, subtle smirk, mysterious editorial attitude",
            tags: ["brunette", "femme-fatale", "intense", "editorial"],
            weight: 1.0
          },
          {
            id: "dirty_blonde_sleek",
            label: "Dirty blonde sleek",
            text_en: "cool modern editorial muse, minimal expression, confident teasing gaze, refined clean attitude",
            tags: ["dirty-blonde", "sleek", "cool", "modern"],
            weight: 1.0
          },
          {
            id: "redhead_sophisticated",
            label: "Redhead sophisticated",
            text_en: "sophisticated elegant muse, serene confident gaze, understated smile, refined high-end vibe",
            tags: ["redhead", "sophisticated", "elegant", "luxury"],
            weight: 0.9
          },
      
          // --- New archetypes (to increase variety) ---
          {
            id: "high_fashion_runway_muse",
            label: "High-fashion runway muse",
            text_en: "high-fashion runway muse, composed expression, sharp editorial presence, confident gaze",
            tags: ["high-fashion", "runway", "editorial", "cool"],
            weight: 1.0
          },
          {
            id: "soft_romantic_muse",
            label: "Soft romantic muse",
            text_en: "soft romantic muse, gentle warm smile, dreamy gaze, intimate but classy vibe",
            tags: ["romantic", "soft", "warm", "tender"],
            weight: 0.95
          },
          {
            id: "playful_tease_muse",
            label: "Playful tease muse",
            text_en: "playful teasing energy, flirty smile, lively eyes, confident relaxed attitude",
            tags: ["playful", "teasing", "flirty", "confident"],
            weight: 1.0
          },
          {
            id: "dominant_power_pose",
            label: "Dominant power vibe",
            text_en: "dominant power vibe, strong posture, assertive gaze, fearless editorial attitude",
            tags: ["dominant", "power", "bold", "editorial"],
            weight: 0.9
          },
          {
            id: "cool_minimal_luxury",
            label: "Cool minimal luxury",
            text_en: "cool minimal luxury vibe, neutral expression, quiet confidence, modern premium presence",
            tags: ["cool", "minimal", "luxury", "modern"],
            weight: 1.0
          },
          {
            id: "retro_pinup_icon",
            label: "Retro pin-up icon",
            text_en: "retro pin-up icon energy, playful charm, classic glamour smile, camera-friendly pose energy",
            tags: ["retro", "pin-up", "classic-glam", "playful"],
            weight: 0.9
          },
          {
            id: "mysterious_noir_muse",
            label: "Mysterious noir muse",
            text_en: "mysterious noir muse, smoldering gaze, minimal smile, cinematic low-key attitude",
            tags: ["noir", "mysterious", "cinematic", "intense"],
            weight: 0.95
          },
          {
            id: "sun_kissed_glam",
            label: "Sun-kissed glam",
            text_en: "sun-kissed glam vibe, relaxed confident smile, bright eyes, effortless magazine energy",
            tags: ["sun-kissed", "fresh", "relaxed", "glamour"],
            weight: 0.85
          },
          {
            id: "luxury_socialite",
            label: "Luxury socialite",
            text_en: "luxury socialite vibe, poised expression, elegant confident gaze, polished premium aura",
            tags: ["luxury", "poised", "elegant", "polished"],
            weight: 0.9
          },
          {
            id: "sporty_toned_confident",
            label: "Sporty toned confident",
            text_en: "sporty toned confidence, energetic gaze, strong healthy vibe, modern campaign attitude",
            tags: ["sporty", "toned", "modern", "confident"],
            weight: 0.85
          },
          {
            id: "glossy_diva_glam",
            label: "Glossy diva glam",
            text_en: "glossy diva glam, bold confident gaze, star-like presence, high-impact editorial energy",
            tags: ["diva", "glossy", "bold", "glamour"],
            weight: 0.85
          },
          {
            id: "girl_next_door_glam",
            label: "Girl-next-door glam",
            text_en: "approachable girl-next-door glam, warm smile, friendly direct gaze, clean modern charm",
            tags: ["approachable", "warm", "clean", "modern"],
            weight: 0.85
          }
        ]
      },
      ...
      beauty: {
        items: [
          // --- Improved existing (neutralized hair color, more anchors) ---
          {
            id: "glossy_waves_smoky",
            label: "Glossy waves + smoky eyes",
            text_en: "long glossy waves, smoky eyes, nude glossy lips, natural skin texture",
            tags: ["hair_long", "hair_waves", "makeup_smoky", "lip_nude_gloss", "skin_natural"],
            weight: 1.0
          },
          {
            id: "soft_blowout_soft_glam",
            label: "Soft blowout + soft glam",
            text_en: "soft blowout waves, soft glam eyes, glossy lips, subtle cheek highlight, natural skin texture",
            tags: ["hair_blowout", "hair_waves", "makeup_soft_glam", "lip_gloss", "skin_natural", "vibe_playful"],
            weight: 1.0
          },
          {
            id: "sleek_straight_winged",
            label: "Sleek straight + winged liner",
            text_en: "sleek glossy straight hair, winged eyeliner, defined lashes, glossy lips, clean skin finish",
            tags: ["hair_sleek", "hair_straight", "makeup_winged", "lip_gloss", "skin_clean"],
            weight: 1.0
          },
          {
            id: "sleek_ponytail_cat_eye",
            label: "Sleek ponytail + cat eye",
            text_en: "sleek high ponytail, sharp cat-eye liner, softly contoured cheeks, glossy lips, clean skin finish",
            tags: ["hair_ponytail", "hair_sleek", "makeup_cat_eye", "skin_clean", "lip_gloss", "vibe_confident"],
            weight: 1.0
          },
          {
            id: "soft_waves_dewy_glow",
            label: "Soft waves + dewy glow",
            text_en: "soft waves, dewy glowing skin, fresh eyes, clear glossy lips, natural texture",
            tags: ["hair_waves", "skin_dewy", "makeup_fresh", "lip_clear_gloss", "skin_natural"],
            weight: 1.0
          },
      
          // --- New: strong variety (hair styles) ---
          {
            id: "wet_look_slicked_back",
            label: "Wet look slicked-back",
            text_en: "slicked-back wet-look hair, high-shine skin highlights, minimal smoky eyes, nude glossy lips, editorial finish",
            tags: ["hair_wet_look", "hair_slicked_back", "skin_glossy", "makeup_minimal_smoky", "lip_nude_gloss", "editorial"],
            weight: 0.85
          },
          {
            id: "messy_bun_minimal_luxury",
            label: "Messy bun + minimal luxury makeup",
            text_en: "messy bun with soft face-framing strands, minimal luxury makeup, softly defined eyes, satin-matte skin, nude lips",
            tags: ["hair_bun", "hair_messy", "makeup_minimal", "skin_satin_matte", "lip_nude", "luxury"],
            weight: 0.85
          },
          {
            id: "half_up_volume_glam",
            label: "Half-up volume glam",
            text_en: "half-up voluminous hair, glamour lashes, softly smoky eyes, glossy lips, warm bronzed glow",
            tags: ["hair_half_up", "hair_volume", "makeup_glam_lashes", "makeup_soft_smoky", "lip_gloss", "skin_bronzed"],
            weight: 0.9
          },
          {
            id: "big_curls_bold_glam",
            label: "Big curls + bold glam",
            text_en: "big defined curls, bold smoky eyes, sculpted cheeks, glossy lips, high-impact glamour finish",
            tags: ["hair_curls", "hair_volume", "makeup_smoky", "skin_sculpted", "lip_gloss", "glamour"],
            weight: 0.75
          },
          {
            id: "curtain_bangs_soft_glam",
            label: "Curtain bangs + soft glam",
            text_en: "curtain bangs with soft waves, soft glam eyes, subtle highlight, nude glossy lips, natural skin texture",
            tags: ["hair_curtain_bangs", "hair_waves", "makeup_soft_glam", "lip_nude_gloss", "skin_natural"],
            weight: 0.8
          },
      
          // --- New: makeup-led variety (lips/eyes/skin) ---
          {
            id: "classic_red_lip_glam",
            label: "Classic red lip glam",
            text_en: "glamour waves, classic red lipstick, softly defined eyes, satin-matte skin, editorial elegance",
            tags: ["lip_red", "makeup_defined_eyes", "skin_satin_matte", "classic-glam"],
            weight: 0.65
          },
          {
            id: "matte_nude_modern",
            label: "Modern matte nude",
            text_en: "sleek modern hair, matte nude lips, sharp eyeliner, clean sculpted complexion, minimal editorial vibe",
            tags: ["lip_matte_nude", "makeup_winged", "skin_sculpted", "modern", "editorial"],
            weight: 0.7
          },
          {
            id: "bronzed_golden_hour",
            label: "Bronzed golden-hour glam",
            text_en: "soft waves, bronzed glowing skin, warm eyeshadow, glossy lips, sun-kissed editorial finish",
            tags: ["skin_bronzed", "skin_dewy", "makeup_warm", "lip_gloss", "sun_kissed"],
            weight: 0.75
          },
          {
            id: "cool_chrome_highlight",
            label: "Cool chrome highlight",
            text_en: "sleek hair, cool-toned highlight, smoky liner, glossy lips, crisp modern editorial finish",
            tags: ["grading_cool_hint", "skin_cool_highlight", "makeup_smoky_liner", "lip_gloss", "modern"],
            weight: 0.7
          },
          {
            id: "sparkle_eyes_night_glam",
            label: "Sparkle eyes night glam",
            text_en: "glamour waves, subtle sparkle eyeshadow, defined lashes, glossy lips, night-out editorial finish",
            tags: ["makeup_sparkle", "makeup_glam_lashes", "lip_gloss", "night_glam"],
            weight: 0.6
          }
        ]
      },
      ...
      wardrobe: {
        items: [
          // --- Improved existing (more detail + normalized tags) ---
          {
            id: "black_lace_corset",
            label: "Black lace corset set",
            text_en: "black lace corset lingerie with satin trim and structured boning, high-waist briefs, sheer lace-top stockings",
            tags: ["color_black", "material_lace", "material_satin", "silhouette_corset", "hosiery_lace_top", "vibe_classic_glam"],
            weight: 1.0
          },
          {
            id: "ivory_satin_balconette",
            label: "Ivory satin balconette set",
            text_en: "ivory satin balconette bra set with scalloped lace trim, high-waist briefs, sheer nude lace-top stockings",
            tags: ["color_ivory", "material_satin", "material_lace", "silhouette_bra_set", "hosiery_lace_top", "hosiery_sheer_nude", "vibe_luxury"],
            weight: 1.0
          },
          {
            id: "deep_red_satin",
            label: "Deep red satin set",
            text_en: "deep red satin lingerie set with subtle black lace trim, high-cut briefs, sheer black stockings",
            tags: ["color_red", "material_satin", "material_lace", "silhouette_bra_set", "hosiery_sheer_black", "vibe_bold"],
            weight: 1.0
          },
          {
            id: "black_lace_bustier",
            label: "Black lace bustier set",
            text_en: "black lace bustier set with clean structured lines, high-waist briefs, subtle fine fishnet stockings (not extreme)",
            tags: ["color_black", "material_lace", "silhouette_bustier", "hosiery_fishnet_subtle", "vibe_editorial"],
            weight: 1.0
          },
          {
            id: "ivory_lace_bodysuit",
            label: "Ivory lace bodysuit",
            text_en: "ivory lace bodysuit lingerie with satin panel details and clean seams, sheer nude stockings",
            tags: ["color_ivory", "material_lace", "material_satin", "silhouette_bodysuit", "hosiery_sheer_nude", "vibe_soft_luxury"],
            weight: 1.0
          },
      
          // --- New: black (commercial staples) ---
          {
            id: "black_satin_bra_set_sheer",
            label: "Black satin bra set + sheer",
            text_en: "black satin underwire bra set with minimal lace accents, mid-rise briefs, sheer black stockings",
            tags: ["color_black", "material_satin", "material_lace", "silhouette_bra_set", "hosiery_sheer_black", "vibe_clean"],
            weight: 0.95
          },
          {
            id: "black_mesh_bodysuit_sheer",
            label: "Black mesh bodysuit + sheer",
            text_en: "black mesh bodysuit lingerie with tasteful paneling and clean lines, sheer black stockings",
            tags: ["color_black", "material_mesh", "silhouette_bodysuit", "hosiery_sheer_black", "vibe_modern"],
            weight: 0.85
          },
          {
            id: "black_embroidered_tulle_set",
            label: "Black embroidered tulle set",
            text_en: "black embroidered tulle lingerie set with delicate patterns, high-waist briefs, sheer black lace-top stockings",
            tags: ["color_black", "material_tulle", "material_embroidery", "silhouette_bra_set", "hosiery_lace_top", "hosiery_sheer_black", "vibe_luxury"],
            weight: 0.75
          },
          {
            id: "black_strappy_bustier_sheer",
            label: "Black strappy bustier (tasteful) + sheer",
            text_en: "black strappy bustier lingerie with tasteful minimal straps and clean hardware, high-waist briefs, sheer black stockings",
            tags: ["color_black", "silhouette_bustier", "hosiery_sheer_black", "vibe_bold", "hardware_gold_hint"],
            weight: 0.65
          },
      
          // --- New: ivory / champagne / nude (premium soft luxury) ---
          {
            id: "champagne_satin_set_nude",
            label: "Champagne satin set + nude",
            text_en: "champagne satin lingerie set with delicate lace trim, high-cut briefs, sheer nude stockings",
            tags: ["color_champagne", "material_satin", "material_lace", "silhouette_bra_set", "hosiery_sheer_nude", "vibe_luxury"],
            weight: 0.85
          },
          {
            id: "nude_mesh_bodysuit_nude",
            label: "Nude mesh bodysuit + nude",
            text_en: "nude-tone mesh bodysuit lingerie with tasteful paneling and clean seams, sheer nude stockings",
            tags: ["color_nude", "material_mesh", "silhouette_bodysuit", "hosiery_sheer_nude", "vibe_minimal"],
            weight: 0.7
          },
          {
            id: "ivory_embroidered_lace_set",
            label: "Ivory embroidered lace set",
            text_en: "ivory embroidered lace lingerie set with scalloped edges, high-waist briefs, sheer nude lace-top stockings",
            tags: ["color_ivory", "material_lace", "material_embroidery", "silhouette_bra_set", "hosiery_lace_top", "hosiery_sheer_nude", "vibe_soft_luxury"],
            weight: 0.75
          },
      
          // --- New: color accents (editorial variety) ---
          {
            id: "midnight_blue_satin_set_black_sheer",
            label: "Midnight blue satin + black sheer",
            text_en: "midnight blue satin lingerie set with subtle lace trim, high-cut briefs, sheer black stockings",
            tags: ["color_blue", "material_satin", "material_lace", "silhouette_bra_set", "hosiery_sheer_black", "vibe_editorial"],
            weight: 0.65
          },
          {
            id: "emerald_satin_bodysuit_black_sheer",
            label: "Emerald satin bodysuit + black sheer",
            text_en: "emerald satin bodysuit lingerie with clean couture lines, sheer black stockings",
            tags: ["color_emerald", "material_satin", "silhouette_bodysuit", "hosiery_sheer_black", "vibe_high_fashion"],
            weight: 0.6
          },
          {
            id: "white_lace_set_nude",
            label: "White lace set + nude",
            text_en: "white lace lingerie set with clean scalloped trim, high-waist briefs, sheer nude stockings",
            tags: ["color_white", "material_lace", "silhouette_bra_set", "hosiery_sheer_nude", "vibe_clean"],
            weight: 0.6
          },
      
          // --- New: “statement silhouettes” (still commercial, non-explicit) ---
          {
            id: "black_teddy_lace_top",
            label: "Black teddy + lace-top",
            text_en: "black lace teddy lingerie with satin accents and clean seams, sheer lace-top stockings",
            tags: ["color_black", "material_lace", "material_satin", "silhouette_teddy", "hosiery_lace_top", "vibe_glamour"],
            weight: 0.7
          },
          {
            id: "ivory_lingerie_dress_nude",
            label: "Ivory lingerie slip dress + nude",
            text_en: "ivory satin lingerie slip dress with delicate lace trim (tasteful), sheer nude stockings",
            tags: ["color_ivory", "material_satin", "material_lace", "silhouette_lingerie_dress", "hosiery_sheer_nude", "vibe_romantic"],
            weight: 0.55
          },
          {
            id: "black_high_cut_set_sheer",
            label: "Black high-cut set + sheer",
            text_en: "black minimal lingerie set with high-cut briefs and clean lines, sheer black stockings",
            tags: ["color_black", "material_minimal", "silhouette_bra_set", "hosiery_sheer_black", "vibe_modern"],
            weight: 0.75
          },
      
          // --- New: latex-look / patent accents (edgy without BDSM) ---
          {
            id: "black_latex_look_set_sheer",
            label: "Black latex-look set + sheer",
            text_en: "black latex-look lingerie set with clean minimal lines and controlled glossy highlights, sheer black stockings",
            tags: ["color_black", "material_latex_look", "silhouette_bra_set", "hosiery_sheer_black", "vibe_edgy"],
            weight: 0.5
          },
          {
            id: "black_patent_accent_bodysuit",
            label: "Black bodysuit with patent accents + sheer",
            text_en: "black bodysuit lingerie with subtle patent-leather accent details and clean seams, sheer black stockings",
            tags: ["color_black", "silhouette_bodysuit", "material_patent_hint", "hosiery_sheer_black", "vibe_edgy", "vibe_editorial"],
            weight: 0.5
          }
        ]
      },
      ...
      shoes: {
        items: [
          // --- Pumps / stilettos (classic sexy, ad-friendly) ---
          {
            id: "nude_patent_pointed_stilettos",
            label: "Nude patent pointed stilettos",
            text_en: "nude patent leather pointed-toe stilettos with a high slim heel",
            tags: ["type_stilettos", "type_pumps", "material_patent", "color_nude", "toe_pointed", "heel_high", "vibe_classic_sexy"],
            weight: 1.0,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "black_patent_pointed_pumps",
            label: "Black patent pointed pumps",
            text_en: "black patent leather pointed-toe pumps with a slim stiletto heel",
            tags: ["type_pumps", "material_patent", "color_black", "toe_pointed", "heel_high", "vibe_power"],
            weight: 1.0,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "red_patent_stilettos",
            label: "Red patent stilettos",
            text_en: "deep red patent leather pointed-toe stilettos with a high slim heel",
            tags: ["type_stilettos", "material_patent", "color_red", "toe_pointed", "heel_high", "vibe_bold"],
            weight: 0.75,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "white_satin_pumps",
            label: "White satin pumps",
            text_en: "ivory satin pointed-toe pumps with a slim heel",
            tags: ["type_pumps", "material_satin", "color_ivory", "toe_pointed", "heel_high", "vibe_soft_luxury"],
            weight: 0.6,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "metallic_silver_pumps",
            label: "Metallic silver pumps",
            text_en: "metallic silver pointed-toe pumps with a slim stiletto heel",
            tags: ["type_pumps", "material_metallic", "color_silver", "toe_pointed", "heel_high", "vibe_editorial"],
            weight: 0.55,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "black_suede_pointed_pumps",
            label: "Black suede pointed pumps",
            text_en: "black suede pointed-toe pumps with a slim high heel",
            tags: ["type_pumps", "material_suede", "color_black", "toe_pointed", "heel_high", "vibe_classic_glam"],
            weight: 0.8,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Strappy heels / sandals (very sexy, still ad-safe) ---
          {
            id: "black_strappy_sandals",
            label: "Black strappy sandals",
            text_en: "black strappy high-heel sandals with thin ankle straps and a slim heel",
            tags: ["type_sandals", "type_strappy", "color_black", "heel_high", "strap_ankle", "vibe_sexy"],
            weight: 0.75,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "nude_strappy_sandals",
            label: "Nude strappy sandals",
            text_en: "nude strappy high-heel sandals with thin straps and a slim heel",
            tags: ["type_sandals", "type_strappy", "color_nude", "heel_high", "vibe_minimal_sexy"],
            weight: 0.7,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "metallic_gold_strappy_heels",
            label: "Metallic gold strappy heels",
            text_en: "metallic gold strappy high-heel sandals with thin straps and a slim heel",
            tags: ["type_sandals", "type_strappy", "material_metallic", "color_gold", "heel_high", "vibe_luxury"],
            weight: 0.55,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "black_peep_toe_heels",
            label: "Black peep-toe heels",
            text_en: "black peep-toe high heels with a slim stiletto heel",
            tags: ["type_heels", "toe_peep", "color_black", "heel_high", "vibe_classic_sexy"],
            weight: 0.5,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Platform heels (club/editorial; use less often) ---
          {
            id: "black_platform_pumps",
            label: "Black platform pumps",
            text_en: "black platform pumps with a high stiletto heel and a sleek silhouette",
            tags: ["type_pumps", "type_platform", "color_black", "heel_high", "vibe_bold"],
            weight: 0.45,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "nude_platform_stilettos",
            label: "Nude platform stilettos",
            text_en: "nude platform stilettos with a high slim heel and clean lines",
            tags: ["type_stilettos", "type_platform", "color_nude", "heel_high", "vibe_bold"],
            weight: 0.4,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Ankle boots (super useful for modern/editorial) ---
          {
            id: "black_leather_ankle_boots",
            label: "Black leather ankle boots",
            text_en: "black leather ankle boots with a slim high heel and pointed toe",
            tags: ["type_boots", "boots_ankle", "material_leather", "color_black", "toe_pointed", "heel_high", "vibe_editorial"],
            weight: 0.8,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "black_suede_ankle_boots",
            label: "Black suede ankle boots",
            text_en: "black suede ankle boots with a slim heel and clean silhouette",
            tags: ["type_boots", "boots_ankle", "material_suede", "color_black", "heel_high", "vibe_classic_glam"],
            weight: 0.7,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "white_ankle_boots",
            label: "White ankle boots",
            text_en: "white leather ankle boots with a slim heel and pointed toe",
            tags: ["type_boots", "boots_ankle", "material_leather", "color_white", "toe_pointed", "heel_high", "vibe_modern"],
            weight: 0.45,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Knee-high boots (classic sexy) ---
          {
            id: "knee_high_suede_boots",
            label: "Knee-high suede boots",
            text_en: "knee-high black suede boots with a slim heel",
            tags: ["type_boots", "boots_knee_high", "material_suede", "color_black", "heel_high", "vibe_sexy"],
            weight: 1.0,
            constraints: { requires: ["include floor"] }
          },
          {
            ...
            text_en: "knee-high black leather boots with a slim high heel and clean lines",
            tags: ["type_boots", "boots_knee_high", "material_leather", "color_black", "heel_high", "vibe_power"],
            weight: 0.85,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "knee_high_patent_boots",
            label: "Knee-high patent boots",
            text_en: "knee-high patent leather boots with a slim stiletto heel",
            tags: ["type_boots", "boots_knee_high", "material_patent", "color_black", "heel_high", "vibe_bold"],
            weight: 0.65,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Thigh-high / over-the-knee boots (signature bold) ---
          {
            id: "thigh_high_patent_boots",
            label: "Thigh-high patent boots",
            text_en: "over-the-knee patent leather thigh-high boots with a slim stiletto heel",
            tags: ["type_boots", "boots_thigh_high", "material_patent", "color_black", "heel_high", "vibe_bold", "bold"],
            weight: 1.0,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "thigh_high_suede_boots",
            label: "Thigh-high suede boots",
            text_en: "over-the-knee black suede thigh-high boots with a slim high heel",
            tags: ["type_boots", "boots_thigh_high", "material_suede", "color_black", "heel_high", "vibe_sexy", "bold"],
            weight: 0.85,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "thigh_high_leather_boots",
            label: "Thigh-high leather boots",
            text_en: "over-the-knee black leather thigh-high boots with a slim stiletto heel and clean silhouette",
            tags: ["type_boots", "boots_thigh_high", "material_leather", "color_black", "heel_high", "vibe_power", "bold"],
            weight: 0.75,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "thigh_high_white_boots",
            label: "Thigh-high white boots",
            text_en: "over-the-knee white leather thigh-high boots with a slim heel (editorial statement)",
            tags: ["type_boots", "boots_thigh_high", "material_leather", "color_white", "heel_high", "vibe_editorial", "bold"],
            weight: 0.4,
            constraints: { requires: ["include floor"] }
          },
      
          // --- Statement / niche (use lower weight) ---
          {
            id: "snake_print_pumps",
            label: "Snake-print pumps",
            text_en: "snake-print pointed-toe pumps with a slim high heel (editorial statement)",
            tags: ["type_pumps", "pattern_snake", "toe_pointed", "heel_high", "vibe_editorial"],
            weight: 0.25,
            constraints: { requires: ["include floor"] }
          },
          {
            id: "burgundy_suede_pumps",
            label: "Burgundy suede pumps",
            text_en: "burgundy suede pointed-toe pumps with a slim high heel",
            tags: ["type_pumps", "material_suede", "color_burgundy", "toe_pointed", "heel_high", "vibe_luxury"],
            weight: 0.35,
            constraints: { requires: ["include floor"] }
          }
        ]
...
class PromptGenerator {
        ...
        for (const module of modulesToResolve) {
            if (!resolved[module]) {
                if (state.randomMode === 'full' || state.randomMode === 'guided') {
                    const item = this.randomSelectModule(module, state.preset);
                    if (item) {
    ...
    randomSelectModule(module, presetId) {
        const items = this.lexicons.get(module);
        ...
        return weightedRandom(candidates, this.rng);
    }
